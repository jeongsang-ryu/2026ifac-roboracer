...
대회는 인천 송도 컨벤시아에서 열립니다. 트랙이 건설될 환경의 특징은 다음과 같습니다:
- 트랙은 20x10m 의 사이즈의 크기입니다.
- 바닥은 카펫 재질입니다.
...
### 2.6.3 정적 장애물
- 각 장애물 영역에 무작위로 하나의 **정적 장애물**이 배치됩니다.
...
### 2.6.4 기록 무효
- 사람이 개입하여 차량에 영향을 준 경우 **랩 타임을 무효화**하고 **완주 랩 수를 재설정**합니다.
- 정적 장애물에 접촉이 있는 경우 **랩 타임을 무효화**하고 **완주 랩 수를 재설정**합니다.
...
### 2.7.3 무작위 정적 장애물
- 각 장애물 영역에 무작위로 하나의 **정적 장애물**이 무작위로 배치됩니다.
- 각 장애물은 0.5m x 0.5m보다 작습니다. 
